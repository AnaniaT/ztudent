...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF00A99D);
  late Color secondary = const Color(0xFF0071BC);
  ...
  late Color accent4 = const Color(0xFFE8EAEE);
  ...
  late Color dropdownBgColor = Color(0xFFE8EAEE);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color accent4 = const Color(0xFF282A2B);
  late Color success = const Color(0xFF04A24C);
  late Color warning = const Color(0xFFFCDC0C);
  late Color error = const Color(0xFFE21C3D);
  late Color info = const Color(0xFF1C4494);
  ...
  late Color dropdownBgColor = Color(0xFF282A2B);
}
